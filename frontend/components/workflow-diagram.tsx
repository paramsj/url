...
const LEFT_LABELS = ["Ingest", "Hash", "Store"]
const RIGHT_LABELS = ["Resolve", "Track", "Expire"]
  ...
  return (
    <div className="relative w-full max-w-[800px] mx-auto">
      <svg
        ...
        role="img"
        aria-label="Workflow diagram showing URL shortening stages: Ingest, Hash, Store, Resolve, Track, Expire"
      >
